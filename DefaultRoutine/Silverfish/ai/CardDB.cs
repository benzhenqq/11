    ...
    public partial class CardDB
    {
        ...
        public class Card
        {
            ...
            public List<Minion> getTargetsForCard(Playfield p, bool isLethalCheck, bool own)
            {
                ...
                // cant play mob, if we have allready 7 mininos
                if (this.type == CardDB.cardtype.MOB && ((own && p.ownMinions.Count >= 7) || (!own && p.enemyMinions.Count >=7))) return retval; 
                // 一样，大于5个奥秘时无法打奥秘
            ...
            public int calculateManaCost(Playfield p)//calculates the mana from orginal mana, needed for back-to hand effects and new draw
            {
                ...
                if (this.Secret)
                {
                    // 奥秘有 nextSecretThisTurnCost0 可以帮助判断
                            ...
                            case 185:
                                {
                                    ...
                                    // {
                                        ...
                                        // if (c.name == CardDB.cardName.unknown)
                                        // {
                                            // Helpfunctions.Instance.ErrorLog("[卡牌解析] 解析失败的卡牌 :" + sb.ToString().ToLower()); 
                                        // }
                                    // }
                                ...
                                break; //CARDNAME
                            // 随从特效
                            case 187: c.Durability = value; break; //durability
        ...
        // 可以用 hashmap 优化到 O(1), 哦，这个函数没用到啊，那没事了
