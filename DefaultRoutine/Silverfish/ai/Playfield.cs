namespace HREngine.Bots
{
    ...
    public class Playfield
    {
        ...
        // 定义当场对局已经使用的奥秘数量
        public int secretsTriggeredSinceRecalc = 0;
        ...
        public Playfield()
        {
            ...
            // 已使用奥秘数量初始化
            this.secretsTriggeredSinceRecalc = 0;
        ...
        public Playfield(Playfield p)
        {
            ...
            this.secretsTriggeredSinceRecalc = p.secretsTriggeredSinceRecalc;
        ...
        public Minion createNewMinion(Handmanager.Handcard hc, int zonepos, bool own)
        {
            ...
            m.Spellburst = hc.card.Spellburst;
        ...
        // 随从失去无法攻击
        public void minionLoseCantAttack(Minion m)
        {
